...
sigma = 5;
D_2_1 = 0;
%D_1_1 = 1205940779932.2099609375;
%D_1_1 = 1205940779939.5584716796875; % lambda =100
%D_1_1 =87357.1177204379273462109267711639404299;
D_1_1= 222;
...
L_max_all = cell(N, 1);
L_max_colors = {'#7E2F8E', 'green', 'blue', 'red'};
...
while true
    ...
    if intersection_found
        ...
        intersection_idx_prev = intersection_idx;
        f_prev_value = f_i(y_values(intersection_idx_prev));
...
fprintf('The absolute difference between the last value of f_i at y = 0.99999 and the target is %e\n', abs_diff);
xlim('auto') % 自动设置 x 轴范围
ylim('auto') % 自动设置 y 轴范围
